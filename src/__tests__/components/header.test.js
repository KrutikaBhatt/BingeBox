...
describe('<Header />', () => {
  it('renders the basic <Header /> with a background', () => {
    const { container, getByText, getByTestId } = render(
      <Header>
        <Header.Frame>
          <Header.Logo src={logo} alt="Binge Box" />
  ...
  it('renders the full <Header> with a background', () => {
      ...
      <Header src="joker1" dontShowOnSmallViewPort>
        <Header.Frame>
          ...
          <Header.Group>
            ...
            <Header.Profile>
              <Header.Picture src="/images/users/3.png" />
              <Header.Dropdown>
                <Header.Group>
                  <Header.Picture src="/images/users/3.png" />
                  <Header.TextLink>Krutika Bhatt</Header.TextLink>
                </Header.Group>
                <Header.Group>
    ...
    expect(getByText('Krutika Bhatt')).toBeTruthy();
